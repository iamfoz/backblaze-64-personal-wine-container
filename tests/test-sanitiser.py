...
LOG = r"""2026-07-05 10:00:01 uploading D:\MediaStore\Plex [Tertiary]\Jane's Old Hard Disk\tax return 2019.pdf
2026-07-05 10:00:02 reading /drive_d/MediaStore/Photos/Holiday/IMG_0042.CR2
...
"""
out = S(LOG)
for term in ["MediaStore", "Jane's Old Hard Disk", "tax return 2019", "Holiday", "IMG_0042",
...
tail = S(r"uploading D:\MediaStore\Photos\IMG_1.CR2")
